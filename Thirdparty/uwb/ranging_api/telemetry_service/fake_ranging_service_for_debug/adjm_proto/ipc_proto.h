...
int start_channel(ipc_channel_t ** c, uint16_t my_id);
int update_channel(ipc_channel_t * c, coordinates_t * coord_list, uint16_t * distance_list, uint16_t activebitmap, uint16_t my_id);
int get_own_coords(ipc_channel_t * c, coordinates_t * coords, uint16_t my_id);
